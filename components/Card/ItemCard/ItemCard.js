    ...
    return ( 
        <div className="product__card__card">
            <div className="product__card">
                ...
                > 
                    {isHovered? <img src={`http://localhost:8800/public/${props.item.category}/${props.item.image[1].filename}`} alt="item" className="product__img"/>: <img src= {`http://localhost:8800/public/${props.item.category}/${props.item.image[0].filename}`} alt="item" className="product__img"/> }
                </div>
